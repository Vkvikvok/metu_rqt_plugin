...
from python_qt_binding.QtCore import Qt, QPointF, QPoint
import rclpy
...
class MyWidget(QWidget):
    def __init__(self):
        ...
        try:
            ...
            # Görseli yükle
            self.customCompetitionMap.load_image('/home/volki/meturover_24/src/metu_rqt_plugin/metu_rqt_plugin/images/gps_test_map.jpg')
