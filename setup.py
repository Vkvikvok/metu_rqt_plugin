...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            "drill_control_publisher = metu_rqt_plugin.threads.sci_hub_publishers_thread:main",
            "sci_plat_control_publisher = metu_rqt_plugin.thread.sci_hub_publishers_thread:main",
            "drill_head_publisher = metu_rqt_plugin.threads.sci_hub_publishers_thread:main",
            "sci_plat_rotation_publisher = metu_rqt_plugin.threads.sci_hub_publishers_thread:main",
        ],
    },
)
